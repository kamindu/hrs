            ...
            <div id="tab">  
                ...
                <div class="well" id="well">
                  <form action="addingstudent.php" method="post" id="details" onsubmit=" return validatingStudents('nic','im','phone')">
					...
					<table>
					<tr>
                                            <td width="150px">Training ID &nbsp;<span class="sp"></span></td>
                                            <td><input type="text" name="tid" id="tid" placeholder="ex: TR001" required="" /></td>
                                            
                                            <td width="150px"><strong>Employee &nbsp;</strong></td>
